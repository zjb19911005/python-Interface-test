...
class testQSRtrade_Wechat(unittest.TestCase):
	...
	def test001(self):
		for m in range(self.x):
			self.i = random.randint(1462900719779, 1462926497979)#服务器时间随机传参
	...
	"versionName": "6.7.1"
			...
			self.re = requests.post("http://calm4.keruyun.com/CalmRouter/v1/trade/submit", data=jdata,headers=head)
			m=m+1,
			s = '操作成功'
			#添加返回判断语句
